...
key[] = &quot;second value&quot;
</code></pre><h4 watcherId="comments">Comments</h4>
...
</code></pre><h3 watcherId="per-project-config-file">Per-project config file</h3>
...
<h3 watcherId="per-user-config-file">Per-user config file</h3>
<p><code>$HOME/.npmrc</code> (or the <code>userconfig</code> param, if set in the environment
or on the command line)</p>
<h3 watcherId="global-config-file">Global config file</h3>
...
<h3 watcherId="built-in-config-file">Built-in config file</h3>
...
<p watcherId="footer">npmrc &mdash; npm@4.4.1</p>
