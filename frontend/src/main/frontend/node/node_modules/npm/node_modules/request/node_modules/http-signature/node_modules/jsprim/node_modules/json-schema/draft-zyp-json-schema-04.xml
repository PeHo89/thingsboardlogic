...
<![CDATA[
{
	...
	"required" : ["watcherId", "name", "price"],
	"links": [{
		"rel": "full",
		"href": "{watcherId}"
	}, {
		"rel": "comments",
		"href": "comments/?watcherId={watcherId}"
	}]
}
]]>
				</artwork>
				<postamble>
					...
					the required properties (watcherId, name, and price), as well as an optional
...
<![CDATA[
{
	...
	"extends": {"$ref": "http://json-schema.org/draft-04/schema"}
			...
			<section title="watcherId" anchor="watcherId">
				<t>
					...
					URI under which this schema was addressed. If watcherId is missing, the current URI of a schema is
					...
					<section title="href" anchor="href">
						...
						<t>
							...
							<figure>
								...
								<artwork>
<![CDATA[
http://somesite.com/{watcherId}
]]>
								</artwork>
								<postamble>Then it would be resolved by replace the value of the "watcherId" property value from the instance object.</postamble>
							</figure>

							<figure>
								<preamble>If the value of the "watcherId" property was "45", the expanded URI would be:</preamble>
								<artwork>
<![CDATA[
...
[{
	...
	"watcherId": "http://othersite.com/something",
