...
array = [{watcherId: 1}, {watcherId: 1}, {watcherId: 2}];

newArray = Hoek.unique(array, "watcherId");  // results in [{watcherId: 1}, {watcherId: 2}]
```
...
array = [{watcherId: 1}, {watcherId: 2}];
newObject = Hoek.mapToObject(array, "watcherId"); // results in [{"watcherId": 1}, {"watcherId": 2}]
```
