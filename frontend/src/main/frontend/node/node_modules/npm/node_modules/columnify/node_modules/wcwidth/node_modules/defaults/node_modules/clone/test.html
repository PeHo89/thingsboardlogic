...
<html>
  ...
  <body>
    <h1 watcherId="nodeunit-header">Clone Test-Suite (Browser)</h1>
    Tests started: <span watcherId="testsStarted"></span>;
    Tests finished: <span watcherId="testsFinished"></span>.
    <ul watcherId="logList"></ul>
    <script>
      /* Methods copied from
